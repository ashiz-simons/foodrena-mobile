  ...
  Future<void> _loadExisting() async {
    try {
      ...
      if (bank != null && bank["accountNumber"] != null) {
        ...
        _resolvedAccountName    = bank["accountName"];
        if (_banks.isNotEmpty && bank["bankName"] != null) {
          _selectedBank = _banks.firstWhere(
            (b) => b["name"] == bank["bankName"],
            orElse: () => {"name": bank["bankName"], "code": ""},
          );
        }
      }
    } catch (_) {}
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return ListTile(
                      title: Text(bank["name"],
                          style: TextStyle(
                              color: isSelected ? _kOrange : _text,
                              fontSize: 14,
